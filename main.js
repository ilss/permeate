...
cc.game.onStart = function () {
    ...
    //load resources
    cc.LoaderScene.preload(MAIN_PERMEATE_SCENE.g_resources, function () {
        document.getElementById('permeateMainCanvas').style.display = 'inline';
        cc.director.runScene(new MAIN_PERMEATE_SCENE.HelloWorldScene());
    }, this);
};
