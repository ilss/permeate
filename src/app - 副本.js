...
MAIN_PERMEATE_SCENE.Permeate_main_layer = cc.Layer.extend({
    ...
    addBg: function () {
        ...
        this._sp_lightning.setPosition(
            MAIN_PERMEATE_SCENE.basic_pos_array.lightning,
        );
        ...
        this._sp_interchanger.setPosition(
            MAIN_PERMEATE_SCENE.basic_pos_array.interchanger,
        );
    ...
    addBlock: function (obj, pos_obj, index) {
        ...
        _block.runAction(
            cc.fadeIn(
                MAIN_PERMEATE_SCENE['_opactions']['_add_block_fadeout_action_time'],
            ),
        );
    ...
    saveNewBlockRequest: function (block_data) {
        if (
            this._block_array.length <
            MAIN_PERMEATE_SCENE['_opactions']['_block_show_num_max']
        ) {
            if (
                GLOBAL_FUNC_SIMPLEEDU.findObjFromArray(
                    block_data,
                    'block_id',
                    this._block_array,
                    '_block_id',
    ...
    addNewBlock: function () {
        ...
        this.runAction(
            cc.scaleTo(
                MAIN_PERMEATE_SCENE['_opactions']['_add_block_fadeout_action_time'],
                MAIN_PERMEATE_SCENE.block_server_num[_len_block_array + 1][
                    'block_scale'
                    ],
            ),
        );
        for (var _index = 0; _index < _len_block_array; _index++) {
            ...
            _new_pos =
                MAIN_PERMEATE_SCENE.block_server_num[_len_block_array + 1]['block_pos'][
                    _index
                    ];
            _old_block.runAction(
                cc.spawn(
                    cc.moveTo(
                        MAIN_PERMEATE_SCENE['_opactions']['_add_block_fadeout_action_time'],
                        _new_pos,
            ...
            // 场上team位置更新
            for (
                var _index_team = 0, _len_team = this._team_array.length;
                _index_team < _len_team;
                _index_team++
            ) {
                var _team = this._team_array[_index_team],
                    _team_new_pos = null;
                _team_new_pos = cc.pAdd(
                    _team.getPosition(),
                    cc.p(
                        _new_pos.x - _old_block_old_pos.x,
                        _new_pos.y - _old_block_old_pos.y,
                    ),
                );
                    ...
                    _team.runAction(
                        cc.moveTo(
                            MAIN_PERMEATE_SCENE['_opactions'][
                                '_add_block_fadeout_action_time'
                                ],
                            _team_new_pos,
                        ),
                    );
        ...
        this._layer_line_yellow.runAction(cc.fadeOut(0.25));
    ...
    alertTeamInfo: function () {
        ...
        var _this = this,
            ...
            _team = this._team_array[
                GLOBAL_FUNC_SIMPLEEDU.findObjFromArray(
                    this._add_block_array[0].team,
                    'block_id',
                    this._team_array,
                    '_team_id',
                )
        ...
        this._layer_add_block_dialog.setScale(
            1.25 /
            MAIN_PERMEATE_SCENE.block_server_num[this._block_array.length][
                'block_scale'
                ],
        );
        ...
        _sp_team_icon_all.setScale(0.1, 0.1);
        ...
        _sp_team_icon_all.runAction(
            cc.spawn(
                cc.fadeIn(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times,
                ),
                cc.scaleTo(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times,
                    1,
        ...
        //小翅膀
        _bg_dialog_linghting_right = new cc.Sprite(
            '#permeate_dialog_wing_right.png',
        );
        ...
        _bg_dialog_linghting_right.runAction(
            cc.spawn(
                cc.fadeIn(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times,
                ),
        ...
        _bg_dialog_linghting_left = new cc.Sprite(
            '#permeate_dialog_wing_right.png',
        );
        ...
        _bg_dialog_linghting_left.runAction(
            cc.spawn(
                cc.fadeIn(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times,
                ),
        ...
        _team_name_ttf.runAction(
            cc.sequence(
                cc.delayTime(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times * 3,
                ),
                cc.spawn(
                    cc.fadeIn(
                        MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times,
        ...
        _bg_dialog_linghting_right = new cc.Sprite(
            '#permeate_dialog_lighting_right.png',
        );
        ...
        _bg_dialog_linghting_right.runAction(
            cc.sequence(
                cc.delayTime(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times + 0.2,
                ),
                cc.fadeIn(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times,
                ),
        ...
        _bg_dialog_border_right = new cc.Sprite(
            '#permeate_dialog_border_right.png',
        );
        ...
        _bg_dialog_border_right.runAction(
            cc.sequence(
                cc.delayTime(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times,
                ),
                cc.spawn(
                    ...
                    cc.moveBy(
                        MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times / 2,
                        cc.p(-30, 0),
                    ),
                ),
            ),
        ...
        _bg_dialog_border_left.runAction(
            cc.sequence(
                cc.delayTime(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times,
                ),
        ...
        _bg_dialog_bottom_right = new cc.Sprite(
            '#permeate_dialog_bottom_right.png',
        );
        _bg_dialog_bottom_right.x = 240;
        _clip_dialog_bottom_right = new cc.Sprite(
            '#permeate_dialog_bottom_mask.png',
        );
        _clipper_dialog_bottom_right = new cc.ClippingNode(
            _clip_dialog_bottom_right,
        );
        ...
        _bg_dialog_bottom_right.runAction(
            cc.sequence(
                cc.delayTime(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times * 2,
                ),
        ...
        _clip_dialog_bottom_left = new cc.Sprite(
            '#permeate_dialog_bottom_mask.png',
        );
        ...
        _bg_dialog_bottom_left.runAction(
            cc.sequence(
                cc.delayTime(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times * 2,
                ),
        ...
        //底部 congratulations
        _sp_dialog_congratulations = new cc.Sprite(
            '#permeate_dialog_congratulations.png',
        );
        ...
        _sp_dialog_congratulations.setScale(0.2, 0.2);
        this._layer_add_block_dialog.addChild(_sp_dialog_congratulations, 1);
        _sp_dialog_congratulations.runAction(
            cc.sequence(
                cc.delayTime(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times * 2,
                ),
        ...
        this._layer_add_block_dialog.runAction(
            cc.sequence(
                cc.delayTime(3),
                cc.fadeOut(
                    MAIN_PERMEATE_SCENE.opations_team_succeed_dialog.action_times,
    ...
    addTeam: function () {
        ...
        _result_team_is_new = GLOBAL_FUNC_SIMPLEEDU.findObjFromArray(
            _obj,
            'group_id',
            this._team_array,
            '_team_id',
        );
        _block_index = GLOBAL_FUNC_SIMPLEEDU.findObjFromArray(
            _obj,
            'attack_block_id',
            this._block_array,
            '_block_id',
        );
        _result_server_has_action_team = this.getServerActionTeamNum(
            _obj.attack_server_id,
        );
        if (_block_index < 0) {
        ...
        if (_result_team_is_new === -1) {
            ...
            _team.setPosition(
                cc.pAdd(MAIN_PERMEATE_SCENE.basic_pos_array.entry, cc.p(0, 30)),
            );
            ...
            _action = cc.spawn(
                cc.moveBy(_team._options.action_time_interchanger_small, cc.p(0, 35)),
                cc.scaleTo(_team._options.action_time_interchanger_small, 1, 1),
                cc.fadeIn(_team._options.action_time_interchanger_small),
            );
            _team.cleanup();
            //避免新增block后坐标发生变化
            var _team_block = this._block_array[
                GLOBAL_FUNC_SIMPLEEDU.findObjFromArray(
                    _team,
                    'attack_block_id',
                    this._block_array,
            ...
            _team.setPosition(
                cc.pAdd(_team_block.getPosition(), _team_block.getServerPos(_team)),
            );
    ...
    teamMoveToBlock: function (team, obj) {
        ...
        if (team.attack_server_id === null) {
            _action.push(cc.delayTime(0.5));
            _path_array =
                MAIN_PERMEATE_SCENE.path_pos_array[this._block_array.length][
                    _block_index
                    ];
            for (var _index = 0, _len = _path_array.length; _index < _len; _index++) {
                ...
                _action.push(
                    cc.moveTo(_action_time, cc.pAdd(_line_end_pos, cc.p(0, 30))),
                );
                _line_start_pos = _line_end_pos;
            }
        } else {
            _action.push(cc.delayTime(0.2));
        }
    ...
    teamMoveToServer: function (team, obj) {
        ...
        //移动到具体server的上
        _line_end_pos = cc.pAdd(
            _block.getPosition(),
            this._block_array[_block_index].getServerPos(obj),
        );
        _distance = cc.pDistance(_line_start_pos, _line_end_pos);
        _action_time = _distance / team._options.team_move_action_distance;
        //如果渗透完成 加2个参数
        ...
        _result_server_has_action_team = this.getServerActionTeamNum(
            obj.attack_server_id,
        );

        if (_result_server_has_action_team.length > 0) {
            var _height_distance =
                _result_server_has_action_team.pop().getPosition().y - _line_end_pos.y;
    ...
    updateAddBlock: function () {
        if (
            this._block_array.length ===
            MAIN_PERMEATE_SCENE['_opactions']['_block_show_num_max'] ||
            this._add_block_array.length === 0
        ) {
