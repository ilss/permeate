...
var Team_class = cc.Node.extend( {
    ...
    attackServer: function ( obj ) {
        ...
        if ( obj.hasOwnProperty( "coin" ) ) {
            ...
            _coin_txt.x = 20 + _team_name.getContentSize().width;
            _coin_txt.y = 22;
            _coin_txt.opacity = 0;
            ...
            _sp_bg_coin.width = _team_name.getContentSize().width + _coin_txt.getContentSize().width + 30;
        ...
        _action_array.push( cc.callFunc( function ( team ) {
            team.is_lock = false;
            team.getParent()._is_action_team-=1;
            cc.log('队伍移动结束更新_is_action_team-------------'+team.getParent()._is_action_team);
        } ) );
        this.cleanup();
